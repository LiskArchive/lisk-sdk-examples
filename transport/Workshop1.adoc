...
[INFO]
====
The IoT device has already been prepared for you before the workshop. **No work needed here!** You can expand the section below if you want to learn about how we have set up the Raspbery Pi.
====
