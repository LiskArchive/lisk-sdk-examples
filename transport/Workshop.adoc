...
In Part 1, we will only make use of the `Initialization`, `LightAlarm` and `Packet&Carrier` pages.
====
...
image:assets/packet-account-1.png[register-packet]

=====  Start transport

image:assets/start-transport.png[register-packet]

image:assets/packet-account-2.png[register-packet]
