...
WARNING: In case the node crashes or doesn't work, follow the xref:create-dev-env/README.md[this guide] to set up a dedicated development environment using a simple Docker script. No need for customized installation.
