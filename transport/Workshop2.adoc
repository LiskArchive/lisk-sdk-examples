...
Next, **copy the code from your local computer** at `transport/transactions/light-alarm.js` (which we prepared in <<1-1-implement-the-lightalarm-transaction, step 1.1>>) to the Raspberry Pi. First, let's open the file with `nano`.
