...
.Check the solutions if needed
****
xref:transactions/solutions[Check out the solutions], which hold the complete working code for the custom transaction types.
