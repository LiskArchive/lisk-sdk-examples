...
.. If you set up the Lisk SDK for the first time, run the following three commands:
+
[source, bash]
----
...
[IMPORTANT]
====
You don't need to do this in the workshop! These steps are already prepared for you before the workshop.
