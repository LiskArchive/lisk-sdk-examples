...
Before running the script, open `print_sendable_registerpackage.js` and set as `packetId` the ID you received when running `create_and_initialize_packet_account.js` .
[source, bash]
----
