...
To be able to log-in using ssh first plug the Raspberry Pi by following the instructions below and then from a terminal run `ping 10.10.10.10` this will start pinging the Raspberry Pi and you'll eventually get responses back.
