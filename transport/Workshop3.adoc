...
TIP: Move on to the next section to find out about advanced knowledge and possible next step.
...
While your tracking script is started and running with `pm2`, execute:
...
To save the process in the list of processes, that will be started autmatically when staring the raspberry pi.
