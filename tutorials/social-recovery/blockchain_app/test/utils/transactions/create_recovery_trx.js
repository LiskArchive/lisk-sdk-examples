...
const { baseAssetSchema, createRecoverySchema } = require('./schemas');
...
const createRecoveryConfigTrs = async ({
    moduleID,
    assetID,
    asset,
    passphrase,
    ...
    return {
        id: id.toString('hex'),
        tx: codec.codec.toJSON(getFullAssetSchema(createRecoverySchema), rest),
        minFee: calcMinTxFee(createRecoverySchema, genesisConfig.minFeePerByte, rest),
        liskClient,
    };
};
